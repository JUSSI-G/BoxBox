...
def build_dataset(pitstops_df, ergast_results, years, grid_positions=None):
    """
...
def run(pitstops_df, ergast_results_by_year, grid_positions=None, start=1994, end=2010, no_plot=False, outputs_dir=None):
    ...
    print("\n── Building Dataset ─────────────────────────────────────────")
    dataset = build_dataset(pitstops_df, all_ergast, years, grid_positions or {})
    if dataset.empty:
